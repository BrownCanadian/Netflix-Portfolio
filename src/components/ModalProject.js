        ...
        <div onClick={()=>{openFunction(false)}} className="rounded-3xl w-screen h-screen bg-transparent backdrop-blur-sm  fixed top-0 z-100 flex flex-col justify-center">
            <div onClick={(e)=>e.stopPropagation()} className="sm:hideen md:block mx-auto md-w-2/3 lg:w-2/5 xl:w-2/5 rounded-3xl flex flex-col">
                <div className="rounded-t-lg w-full flex flex-col">
                  ...
                  */}  </div> 
                  <h1 className=  "pt-2  text-white font-netflix text-3xl ml-8 bg-transparent drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] z-20">{name}</h1>
                  <   button className="mt-4 mb-4 flex w-36 bg-white text-black font-netflix  px-2 py-2 rounded-md mx-6 lg:px-2 hover:scale-110"> <img alt="" className="bg-transparent pr-2" src="data:image/svg+xml;base64,"/>More Info</button> 
                </div>
