    ...
    <div className="-mb-12">
      <div className="pl-12 mb-16">
        ...
        <div className="relative w-full overflow-hidden">
          ...
          <img className=" rounded-lg scale-50 lg:scale-75  -mr-32 lg:-mr-10 hover:scale-100 hover:z-30" src="http://occ-0-321-1009.1.nflxso.net/dnm/api/v6/6gmvu2hxdfnQ55LZZjyzYR4kzGk/AAAABVwbXKQbCtE6nfY5PW7hUq885LHugSqbM2FgCYcyxOVIjlrTrSzQ12WGKcb-9I1cs2-naCwiHlur7gfksTd5FWMW9DWdS9IGIDFrG1tkbdPQPJZDs2vmY_oDI01EjvcP3hKt1feOWtrnhjb5QeZRdWBKPRnZKrOH8e4.webp?r=4e4"/>
